...
namespace zae
{
	...
	{
		auto window = static_cast<Window*>(glfwGetWindowUserPointer(glfwWindow));
		window->onKey(static_cast<Key>(key), static_cast<InputAction>(action), (InputMod)mods);
	}
	...
	{
		auto window = static_cast<Window*>(glfwGetWindowUserPointer(glfwWindow));
		window->onMouseButton(static_cast<MouseButton>(button), static_cast<InputAction>(action), (InputMod)mods);
	}
