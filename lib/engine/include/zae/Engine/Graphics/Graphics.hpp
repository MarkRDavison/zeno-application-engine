...
#include <zae/Engine/Graphics/Devices/Instance.hpp>
#include <zae/Engine/Graphics/Devices/LogicalDevice.hpp>
#include <zae/Engine/Graphics/Devices/PhysicalDevice.hpp>
#include <zae/Engine/Graphics/Devices/Surface.hpp>
...
namespace zae
{
	...
	public:
		...
		~Graphics();
	public:
		static Graphics* Get() // TODO: Better scope management
		{
			if (Instance == nullptr)
			{
	...
	private:
		...
		void OnAddWindow(Window* window, bool added);
		...
		std::unique_ptr<zae::Instance> instance;
