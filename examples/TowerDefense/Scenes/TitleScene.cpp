...
void TitleScene::Start()
{
...

	{
		...
		e->SetName("TITLE");
		SetTextInfo(e, "TITLE_FONT", "Tower Defense!!!", 64, {8.0f, 8.0f, 0.0f});
	}
	{
		auto e = entities.CreateEntity();
		e->SetName("START");
		SetTextInfo(e, "TITLE_FONT", "Start", 36, { 8.0f, 32.0f + 72.0f * 1.0f, 0.0f });
	}
	{
		auto e = entities.CreateEntity();
		e->SetName("OPTIONS");
		SetTextInfo(e, "TITLE_FONT", "Options", 36, { 8.0f, 32.0f + 72.0f * 2.0f, 0.0f });
	}
	{
		auto e = entities.CreateEntity();
		e->SetName("QUIT");
		SetTextInfo(e, "TITLE_FONT", "Quit", 36, { 8.0f, 32.0f + 72.0f * 3.0f, 0.0f });
	}
}
